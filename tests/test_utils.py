...
def test_parse_salary():
    # Тестовые данные
    vacancy_with_salary_dict = {"salary": {"currency": "RUB", "from": 100000}}

    vacancy_with_salary_from = {"salary_from": 150000, "currency": "RUB"}

    vacancy_with_uzs = {"salary": {"currency": "UZS", "from": 1000000}}

    vacancy_with_invalid_salary = {"salary": {"currency": "RUB", "from": "сто тысяч"}}  # Некорректное значение
