    ...
    while True:
        ...
        if choice == "1":
            try:
                ...
                sorted_vacancies = sorted(vacancies, key=lambda x: parse_salary(x), reverse=True)
            ...
            filtered_vacancies = [vac for vac in vacancies if keyword.lower() in vac["requirements"].lower()]
